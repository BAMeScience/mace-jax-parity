...
benchmark: models/mace_jax_bundle
	python scripts/benchmark_mace_torch_vs_jax.py --torch-model models/mace_foundation.pt --jax-model models/mace_jax_bundle --device cuda --max-edges-per-batch 60000 --max-nodes-per-batch 100000 --prefetch-batches 8
